<template>
  <div class="w-2/5 m-auto py-5">
    ...
    <div class="flex gap-5 items-center justify-center">
      <select v-model="funcionario.turno">
        <option>Selecione</option>
        <option value="1">04:40 as 13:00</option>
        <option value="2">12:40 as 21:00</option>
        <option value="3">15:40 as 00:00</option>
        <option value="4">20:40 as 05:00</option>
      </select>
    </div>
            ...
            >
              ...
              <td class="py-3 px-6 text-center">
                <div class="flex item-center justify-center">
                  <button @click="editarFuncionario(i)">
                    <div
                      class="
                        w-4
                        mr-2
